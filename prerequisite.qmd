...
* Aller sur la page web [https://docs.posit.co/ide/user/#rstudio-ide-oss-downloads/](https://docs.posit.co/ide/user/#rstudio-ide-oss-downloads/) et cliquer sur le lien de téléchargement correspondant à votre système d'exploitation. Ouvrir le fichier téléchargé et suivre les étapes pour installer le logiciel. Une fois l'installation terminée, ouvrir le logiciel RStudio pour vérifier que l'installation s'est bien passée.
