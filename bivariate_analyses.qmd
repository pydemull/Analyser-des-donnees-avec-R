...
g1 <- 
  ...
  annotate("text", label = "italic(bar(X)[1])", x = 1.8, y = 9.7, size = 7, parse = TRUE) +
  geom_segment(aes(x = 9, y = 4, xend = 7, yend = 5.9), arrow = arrow(length = unit(0.5, "cm")), size = 0.8) +
  annotate("text", label = "italic(bar(Y)[1])", x = 9.9, y = 4, size = 7, parse = TRUE) +
