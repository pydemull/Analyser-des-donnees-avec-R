...
```{r graphsee, echo = FALSE, message = FALSE, fig.align = "center", fig.cap="Illustration d'un modèle linéaire (en bleu) et de ses résidus (en rouge)"}
