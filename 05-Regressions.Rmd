...
```{r graphsee, echo = FALSE, message = FALSE, fig.cap="Illustration d'un modèle linéaire (en bleu) et de ses résidus (en rouge)"}
...
```{r graphLinStats,  message = FALSE, warning = FALSE, fig.cap = "Régression linéaire avec les informations correspondantes"}
...
```{r anscombeQuartetGraph, echo = FALSE,  fig.cap="Le quartet d'Anscombe"}
size <- 3
color <- "red"
