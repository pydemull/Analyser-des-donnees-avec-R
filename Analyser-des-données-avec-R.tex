...
{\centering \includegraphics{Analyser-des-données-avec-R_files/figure-latex/raindcloudplotsBivPaired1-1} 
...
\emph{Qualification de l'importance de la différence standardisée}
