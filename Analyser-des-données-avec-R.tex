...
{\centering \includegraphics[width=0.8\linewidth]{Analyser-des-données-avec-R_files/figure-latex/unnamed-chunk-18-1} 

}

\caption{Visualisation des fréquences dans le jeu de données `cartes`}\label{fig:unnamed-chunk-18}
\end{figure}
