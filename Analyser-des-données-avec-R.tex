...
\tightlist
\item
  Le test du \(\chi^2\) d'adéquation consiste à comparer une distribution observée à et une distribution théorique qui représenterait l'hypothèse à tester.
\item
