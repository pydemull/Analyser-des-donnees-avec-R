...
#| echo: false
#| message: false
#| fig-cap: "Illustration d'un modèle linéaire (en bleu) et de ses résidus (en rouge)"
#| label: fig-graphsee
...
ggplot(data = dfR2) +
  geom_segment(aes(x = hp, xend = hp, y = pred, yend = mpg), color = "red", linewidth = 1) +
...
#| message: false
#| warning: false
#| fig-cap: "Régression linéaire avec les informations correspondantes"
#| label: fig-graphLinStats
...
```{r anscombeQuartetGraph}
#| out-width: '70%'
#| echo: false
#| fig-cap: "Le quartet d'Anscombe"
#| label: fig-anscombeQuartetGraph
