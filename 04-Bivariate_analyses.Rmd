...
```{r raindcloudplotsBivUnpaired1, out.height= '40%', echo = FALSE, fig.cap="Exemples de raindcloud plots à l'horizontale pour des données non appariées"}
library(patchwork)
(A | B)
```
...
```{r raindcloudplotsBivUnpaired2, out.height= '40%',  echo = FALSE, fig.cap="Exemples de raindcloud plots à la verticale pour des données non appariées"}
library(patchwork)
(A | B)
```
...
```{r raindcloudplotsBivPaired1, echo = FALSE,  out.height='40%', fig.cap="Exemples de raindcloud plots à l'horizontale  pour des données appariées"}
(A |B)
```
...
```{r raindcloudplotsBivPaired2, echo = FALSE,  out.height='40%', fig.cap="Exemples de raindcloud plots à la verticale pour des données appariées"}
(A |B)
```
...
```{r, out.height='40%', echo = FALSE, fig.cap = "Exemple de figure pour montrer la médiane des différences dans le cas de données appariées"}
A | B
```
