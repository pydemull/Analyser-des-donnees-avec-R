...
```{r simpsonquant, out.width='90%', echo=FALSE, message = FALSE, fig.cap="Influence du niveau d'analyse (groupe entier vs. sous-groupes) sur la corrélation observée entre deux variables quantitatives"}
library(correlation)
library(ggplot2)
library(patchwork)
set.seed(123)
