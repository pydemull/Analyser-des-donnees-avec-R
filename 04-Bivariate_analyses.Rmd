...
A <-
  ggplot(data = iris_two_species, aes(x = Species, y = Sepal.Length, color = Species, fill = Species)) +
...
# horizontale
C <-
  ggplot(data = iris_two_species, aes(x = 0, y = Sepal.Length, color = Species, fill = Species)) +
...
E <-
  ggplot(data = Blink2, aes(x = Condition, y = Blink_rate,  colour = Condition, fill = Condition)) +
...
# Pour déplacer l'axe des observations individuelles : https://github.com/tidyverse/ggplot2/issues/4491
# Pour la conception des raincloud plots : https://github.com/jorvlan/raincloudplots
```
...
A <-
  ggplot(data = Blink2 %>% filter(Condition != "Difference"), aes(x = Condition, y = Blink_rate, 
