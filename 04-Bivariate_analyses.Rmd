...
```{r distriUCBA, fig.height = 8, out.width='100%', echo = FALSE, message=FALSE, fig.cap= "Distribution des étudiants femmes et hommes par département à l'Université de Berkeley en 1973 (Bickel et al., 1975)"}
recap_dep2 <- 
  results_univ %>%
  dplyr::select(-result) %>%
  group_by(department, gender) %>%
