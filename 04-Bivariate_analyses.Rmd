...
```{r iris tw species view, echo = FALSE, warning = FALSE, fig.align="center"}
iris_two_species <-
  iris %>% 
...
Ici, la valeur ne change pas beaucoup par rapport au cas précédent, car l'effectif n'est pas si petit que cela ($N_{1}$ + $N_{2}$ = 100 ici, ce qui fait que la correction appliuqée au $d_{s}$ de Cohen est minime).
