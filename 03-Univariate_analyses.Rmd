...
```{r geomboxplot, fig.align ="center", fig.height=3, fig.cap="Exemple de boîte à moustaches"}
ggplot(data = iris, aes(x = Sepal.Length)) + 
  geom_boxplot() +
...
```{r geomboxplotModified, fig.align = "center", fig.height=3, , fig.cap="Visualisation d'un outlier"}
...
```{r geomboxplotOutlierId, fig.align ="center", fig.height=3, ,fig.cap="Identification d'un outlier"}
...
```{r gdistriExample, message = FALSE, fig.align ="center", fig.cap="Visualisation de la distribution avec la fonction `g_distri()`"}
