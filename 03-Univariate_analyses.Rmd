...
```{r geom_histogram, fig.align ="center"}
...
```{r geom_histogram with pipe, eval = FALSE, fig.align ="center"}
iris %>% 
...
```{r geom_histogram with varied binwidth_1, eval = FALSE, fig.align ="center"}
...
```{r geom_histogram with varied binwidth_2, echo = FALSE, fig.align ="center"}
...
```{r geom_boxplot, fig.align ="center"}
ggplot(data = iris, aes(x = Sepal.Length)) + 
  geom_boxplot() +
...
```{r geom_boxplot modifié, fig.align ="center"}
...
```{r geom_boxplot with outlier id, fig.align ="center"}
...
```{r vizualising outliers with ggstatplot, warning = FALSE, message = FALSE, fig.align ="center"}
library(ggstatsplot) 
iris %>%
  mutate(id = as.factor(rep(1:50, times = 3))) %>%
...
```{r g_distri example, message = FALSE, fig.align ="center"}
...
```{r various distributions, echo = FALSE, message = FALSE, fig.align ="center"}
set.seed(123)
...
```{r means with skewed variables, echo = FALSE, message = FALSE, warning = FALSE, fig.align ="center"}
# Get legend function
...
```{r medians with skewed variables, echo = FALSE, message = FALSE, warning = FALSE, fig.align ="center"}
# Graphique pour la distribution gaussienne
set.seed(123)
gauss <- tibble(x = rnorm(n = 1000, mean = 0, sd = 1))
mean_gauss <- mean(gauss$x)
...
```{r graphic for continuous quantiles, echo = FALSE, fig.align ="center"}
...
```{r skewed distri, echo = FALSE, message = FALSE, warning = FALSE, fig.align ="center"}
set.seed(123)
...
```{r kurtosis distri, echo = FALSE, message = FALSE, warning = FALSE, fig.align ="center"}
...
```{r observations within sd mutiples with gaussian distributions, echo = FALSE, warning = FALSE, message = FALSE, fig.align ="center"}
set.seed(123)
...
```{r mean above median aysm, echo = FALSE, warning = FALSE, message = FALSE, fig.align ="center"}
...
```{r geom_bar enhanced, message = FALSE, fig.align ="center"}
diamonds %>% 
  group_by(color) %>%
  summarize(count = n())
...
```{r geom_bar enhanced 2, message = FALSE, fig.align ="center"}
...
```{r geom_bar enhanced graph, echo = FALSE, message = FALSE, fig.align ="center"}
(g1 | g2 | g3) / (g4 | g5 | g6)
```
...
```{r diagrams for proportions, message = FALSE, fig.align ="center"}
...
```{r geom_bar prop enhanced graph, echo = FALSE, message = FALSE, fig.align ="center"}
(g1 | g2) / (g3 | g4)
```
