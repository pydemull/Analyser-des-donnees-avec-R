...
```{r geomhistogramVariedBinwidth2, out.width='90%', echo = FALSE,  fig.cap="Différentes largeurs d'intervalles pour un histogramme"}
...
```{r geomboxplot,  fig.height=2, fig.cap="Exemple de boîte à moustaches", out.width='90%'}
ggplot(data = iris, aes(x = Sepal.Length)) + 
  geom_boxplot() +
...
```{r geomboxplotModified, fig.height=2, fig.cap="Visualisation d'un outlier", out.width='90%'}
...
```{r geomboxplotOutlierId, fig.height=2, fig.cap="Identification d'un outlier", out.width='90%'}
...
```{r meansSkewedVariables, out.width = '90%', echo = FALSE, message = FALSE, warning = FALSE, fig.cap="Effet de la forme de la distribution sur la position de la moyenne"}
# Get legend function
...
```{r mediansSkewedVariables, out.width  = '90%', echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Effet de la forme de la distribution sur la position de la médiane"}
# Graphique pour la distribution gaussienne
set.seed(123)
gauss <- tibble(x = rnorm(n = 1000, mean = 0, sd = 1))
mean_gauss <- mean(gauss$x)
...
```{r diagrams for proportions, message = FALSE, out.width = '100%'}
