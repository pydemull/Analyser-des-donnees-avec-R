...
```{r geomboxplot,  fig.height=2, fig.cap="Exemple de boîte à moustaches", out.width='80%'}
ggplot(data = iris, aes(x = Sepal.Length)) + 
  geom_boxplot() +
...
```{r geomboxplotModified, fig.height=2, fig.cap="Visualisation d'un outlier", out.width='80%'}
...
```{r geomboxplotOutlierId, fig.height=2, fig.cap="Identification d'un outlier", out.width='80%'}
...
```{r, raincloudUnivar, fig.cap="Exemple de raincloud plot", out.width='80%'}

# Code modifié à partir de https://www.cedricscherer.com/2021/06/06/visualizing-distributions-with-raincloud-plots-and-how-to-create-them-with-ggplot2/
library(gghalves)
library(ggdist)
...
```{r variousDistributions, echo = FALSE, message = FALSE, fig.cap="Différents types de distributions", out.width='80%'}
set.seed(123)
...
```{r graphicContinuouQuantiles, out.width = '80%', echo = FALSE, fig.cap="Détermination des quartiles Q1 et Q3 avec une variable quantitative continue"}
...
```{r skeweddistri, out.width = '80%', echo = FALSE, message = FALSE, warning = FALSE, fig.cap="Valeur du Skewness selon la forme de la distribution"}
set.seed(123)
...
```{r kurtosisdistri, out.width = '80%', echo = FALSE, message = FALSE, warning = FALSE,  fig.cap="Valeur du Kurtosis selon la forme de la distribution"}
