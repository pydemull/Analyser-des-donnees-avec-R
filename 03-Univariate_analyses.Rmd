...
```{r meansSkewedVariables, out.width = '80%', echo = FALSE, message = FALSE, warning = FALSE, fig.cap="Moyenne d'une variable présentant une distribution asymétrique"}
# Get legend function
...
```{r graphicContinuouQuantiles, out.width = '60%', echo = FALSE, fig.cap="Calcul des quartiles Q1 et Q3 avec une variable quantitative continue"}
...
TextPlot_chisq1 <- 
            ggplot() + 
            annotate(geom = "text", x = 4, y = 1, size = 3, label = bquote(paste(gamma[1], " = ", .(round(skewness(chis_1$x), 2))))) +
            theme(
              plot.background = element_blank(), 
              panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(), 
...
TextPlot_chisq4 <- 
            ggplot() + 
            annotate(geom = "text", x = 4, y = 1, size = 3, label = bquote(paste(gamma[1], " = ", .(round(skewness(chis_4$x), 2))))) +
            theme(
              plot.background = element_blank(), 
              panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(), 
...
TextPlot_gauss <- 
            ggplot() + 
            annotate(geom = "text", x = 4, y = 1, size = 3, label = bquote(paste(gamma[1], " = ", .(round(skewness(gauss$x), 2))))) +
            theme(
              plot.background = element_blank(), 
              panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(), 
...
TextPlot_chisq4_neg <- 
            ggplot() + 
            annotate(geom = "text", x = 4, y = 1, size = 3, label = bquote(paste(gamma[1], " = ", .(round(skewness(chis_4_neg$x), 2))))) +
            theme(
              plot.background = element_blank(), 
              panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(), 
...
TextPlot_chisq1_neg <- 
            ggplot() + 
            annotate(geom = "text", x = 4, y = 1, size = 3, label = bquote(paste(gamma[1], " = ", .(round(skewness(chis_1_neg$x), 2))))) +
            theme(
              plot.background = element_blank(), 
              panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(), 
...
TextPlot_unif <- 
            ggplot() + 
            annotate(geom = "text", x = 4, y = 1, size = 3, label = bquote(paste(gamma[2], " = ", .(round(kurtosis(unif$x), 2))))) +
            theme(
              plot.background = element_blank(), 
              panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(), 
...
TextPlot_gauss <- 
            ggplot() + 
            annotate(geom = "text", x = 4, y = 1, size = 3, label = bquote(paste(gamma[2], " = ", .(round(kurtosis(gauss$x), 2))))) +
            theme(
              plot.background = element_blank(), 
              panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(), 
...
TextPlot_laplace <- 
            ggplot() + 
            annotate(geom = "text", x = 4, y = 1, size = 3, label = bquote(paste(gamma[2], " = ", .(round(kurtosis(laplace$x), 2))))) +
            theme(
              plot.background = element_blank(), 
              panel.grid.major = element_blank(),
              panel.grid.minor = element_blank(), 
...
```{r MeanAboveLedianAsym, out.width='80%', echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Moyenne et médiane dans le cadre d'une distribution asymétrique"}
