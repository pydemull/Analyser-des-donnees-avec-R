...
```{r plot function 1, eval = FALSE, fig.align ="center"}
...
```{r plot function 2, echo = FALSE, fig.align ="center"}
plot(x = iris$Sepal.Length, y = iris$Petal.Length)
```
...
```{r plot function 3, eval = FALSE, fig.align ="center"}
...
```{r plot function 4, eval = FALSE, fig.align ="center"}
...
```{r plot function 5, fig.align ="center"}
